...
const tableVariants = tv({
  slots: {
    base: [
      "ring-opacity-50 w-full divide-y divide-gray-300 rounded ring-2 ring-gray-200",
    ],
    header: ["bg-gray-50 data-[focused]:ring-0"],
    body: [""],
    footer: ["bg-muted/50 border-t font-medium [&>tr]:last:border-b-0"],
    column: [
      "py-3.5 pr-3 pl-4 text-left text-sm font-semibold text-gray-900 outline-none",
    ],
