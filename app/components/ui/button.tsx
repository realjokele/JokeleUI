...
const buttonStyles = tv({
  base: [
    ...
    "inset-ring-(--inset-ring) pressed:bg-(--btn-overlay) dark:inset-ring-fg/15 bg-(--btn-bg) text-(--btn-fg) inset-ring hover:bg-(--btn-overlay) dark:shadow-none",
  ...
  variants: {
    intent: {
      ...
      secondary: [
        ...
        "[--inset-ring:theme(--color-button-secondary-fg)]",
